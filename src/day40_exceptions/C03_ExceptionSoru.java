...
public class C03_ExceptionSoru {
    public static void main(String[] args) {
        ...
        // girdigi sayilarin pozitif olanlari yazdirin
        ...
        while (!girilenHarf.equalsIgnoreCase("Q")){
            System.out.println("Lutfen toplamak uzere pozitif tamsayilar giriniz" +
            ...
            try {
                ...
                if (girilenSayi>0){
                    ...
                    System.out.println("Negatif sayilar veya 0 toplama eklenmez");
                }
            } catch (Exception e) {
